# Contributing to actix-actor-expect

Thanks for your interest in actix actor expect.

## Getting Started

Actix-actor-expect [open issues are here](https://github.com/eisberg-labs/actix-actor-expect/issues). Issues can include bugs to fix, features to add, or documentation that looks outdated.
